...
{
       2,     0,     1,    13,    14,     0,     4,     0,     0,     5,
       0,    14,    11,     0,     3,     0,     0,     0,     0,     6,
      12,     7,     8,     9,    10
};
...
#line 1181 "parser.tab.c"
  ...
  case 14: /* expr: T_ID  */
#line 79 "parser.y"
                             { (yyval.ival) = getval((yyvsp[0].sval)); free((yyvsp[0].sval)); }
